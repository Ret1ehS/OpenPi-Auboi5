...
from pyorbbecsdk import Device, FormatConvertFilter, VideoFrame
from pyorbbecsdk import OBConvertFormat, OBFormat, OBSensorType
...
def determine_convert_format(frame: VideoFrame):
    ...
    if frame.get_format() == OBFormat.YUYV:
        return OBConvertFormat.YUYV_TO_RGB888
    if frame.get_format() == OBFormat.NV21:
        return OBConvertFormat.NV21_TO_RGB888
    if frame.get_format() == OBFormat.NV12:
        return OBConvertFormat.NV12_TO_RGB888
    if frame.get_format() == OBFormat.UYVY:
